...
const CreatePG = () => {
  ...
  const [sharingTypes, setSharingTypes] = useState([{ type: 1, price: '', available: true }]);
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">Create a new PG listing</p>
        </div>
        <button
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <input {...register('title')} className="input" placeholder="Enter PG title" />
              {errors.title && <p className="text-red-500 text-sm mt-1">{errors.title.message}</p>}
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
              <textarea {...register('description')} rows={4} className="input" placeholder="Describe your PG" />
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <input {...register('location.address')} className="input" placeholder="Full address" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">City</label>
              <input {...register('location.city')} className="input" placeholder="City" />
            </div>
          </div>
        ...
        <div className="flex justify-end space-x-4">
          ...
          >
            {createPG.isPending ? 'Creating...' : 'Create PG Listing'}
          </button>
        </div>
      </form>
    </div>
